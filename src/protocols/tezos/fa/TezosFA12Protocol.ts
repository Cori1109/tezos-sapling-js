...
export class TezosFA12Protocol extends TezosFA1Protocol {
  public async getAllowance(
    ...
    const getAllowanceCall = await this.contract.createContractCall(
      TezosFA12ContractEntrypoint.ALLOWANCE,
      [
        {
          owner: ownerAddress,
    ...
    return this.getContractCallIntResult(
      getAllowanceCall,
      this.requireSource(source, spenderAddress, "kt")
    )
  }
  ...
  public async approve(
    ...
    const approveCall = await this.contract.createContractCall(
      TezosFA12ContractEntrypoint.APPROVE,
      {
        spender: spenderAddress,
